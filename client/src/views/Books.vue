<template>
  <h2 class="search-title center-text">KHO SÁCH</h2>
    <form class="d-flex" role="search" @submit.prevent="searchBooks">
    <input class="form-control me-2" type="search" v-model="searchTerm" placeholder="Tìm kiếm sách" aria-label="Search">
...
<style scoped>
  ...
  .search-title {
    margin-right: 20px; /* Add margin right for spacing between title and search bar */
    font-size: 24px;
    font-weight: bold;
